...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  /* |---------------------------------------------+---------------------------------------+-------------------------------------------------|*/
        LOWER,          XXXXXXX,  XXXXXXX,  KC_LGUI,  KC_SPC,   KC_SPC,   RAISE,    KC_ENT,   LALT_T(KC_QUOT),  KC_LEFT,  KC_DOWN,    KC_RGHT
  /* `---------------------------------------------------------------------------------------------------------------------------------------' */
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   -  |   =  |   [  |   ]  |  \   |ISO # |ISO / |Pg Up |Pg Dn |      | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |             |      |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMBER] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LSFT,
    _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______, KC_DEL,
...
[_NAVIGATION] = LAYOUT_planck_grid(
    KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,     KC_UP,     KC_F22, KC_F23, KC_F24,
